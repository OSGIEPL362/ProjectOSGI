...
public interface medicalFunctions {
	...
	boolean addStaff(int id, String name, String Address, String clinic,
			String username, String password, int doc, int nurse,
			int receptionist, int health, int manager);
	...
	boolean editPatient(int id, String name, String Address, int level,
			String realative, int hurm, int dead);

	boolean editStaff(int id, String name, String Address, String clinic,
			String username, String password, int doc, int nurse,
			int receptionist, int health, int manager);
